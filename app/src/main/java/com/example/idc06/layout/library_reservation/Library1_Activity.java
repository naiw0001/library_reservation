 ...
 */
public class Library1_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void okay(View v){
       ...
       final String  result = year + "년" + month + "월" + day + "일" + hour + "시" + min + "분";
        ...
        dialog = new AlertDialog.Builder(Library1_Activity.this);
        dialog.setTitle("확인");
        ...
        dialog.setPositiveButton("확인", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                database(result,now);
                startActivity(new Intent(Library1_Activity.this,Reservation.class));
                finish();
            }
        });
