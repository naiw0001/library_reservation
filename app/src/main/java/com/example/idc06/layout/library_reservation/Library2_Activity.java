 ...
 */
public class Library2_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void okay(View v){
        ...
        dialog = new AlertDialog.Builder(Library2_Activity.this);
        dialog.setTitle("확인");
        ...
        dialog.setPositiveButton("확인", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                database(result,now);
                startActivity(new Intent(Library2_Activity.this,Reservation.class));
                finish();
    ...
    public void database(String result,String now){
        final String temp = "http://10.142.47.250:8000/naiw/reservation_li1.php";
